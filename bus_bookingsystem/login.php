...
$result="";
    ...
    {
        $bno = mysqli_real_escape_string($con, strtolower($_POST['bno']));
        //$phone = mysqli_real_escape_string($con, $_POST['phone']);
        $check_email = "SELECT * from register WHERE bno = '$bno'";
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="d-block d-sm-flex  align-items-center">
                                                        ...
                                                        <a href="javascript:void(0);" class="ml-auto">Forgot Bus Registration Number ?</a>
                                                    </div>
                                                </div>
