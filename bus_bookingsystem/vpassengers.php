...
// Fetch all active bookings and passenger details
...
<head>
    ...
    <meta name="description" content="Admin template to view all passengers" />
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        echo "<tr><td colspan='13' class='text-center'>No passengers found.</td></tr>";
                                                    }
                                                    ?>
                                                </tbody>
                                            </table>
